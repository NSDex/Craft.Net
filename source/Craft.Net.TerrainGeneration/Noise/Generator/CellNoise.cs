...
{
	/// <summary>
	/// Noise provider that implements Cell Noise.
	/// </summary>
	/// <remarks>
    ...
    /// 
    /// This implementation is from <http://aftbit.com/cell-noise-2/>
    /// with modifications by NSDex.
	/// </remarks>
	public class CellNoise : INoiseProvider
	{
        ...
        /// <summary>
        /// Inserts value into array using insertion sort.
        /// </summary>
        ...
        /// <summary>
        /// </summary>
        public delegate void InsertionFunction(ArrayList points, double value);
        /// <summary>
        /// </summary>
        ...
        public CellNoise(int seed, DistanceFunction distanceFunc, InsertionFunction insertFunc, ReductionFunction reductionFunc)
		{
            this.seed = seed;
